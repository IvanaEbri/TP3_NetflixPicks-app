...
class MainWindow:
    ...
    def botones(self): # Funcion que crea los botones segun lo que se necesite. 
        self.button_a = Button(self.q_frame, relief="raised", command=lambda : self.apretar_button(self.button_a, self.app.button1), text=self.app.button1, width=13, height=2, compound="center", bg="White", font=("Bebas neue", 12, "bold"), fg="Black", wraplength=115)
        self.button_a.pack(side="left", padx=13, pady=20)

        self.button_b = Button(self.q_frame, relief="raised", command=lambda : self.apretar_button(self.button_b, self.app.button2), text=self.app.button2, width=13, height=2, compound="center", bg="White", font=("Bebas neue", 12, "bold"), fg="Black", wraplength=115)
        self.button_b.pack(side="left", padx=13, pady=20)

        self.button_c = Button(self.q_frame, relief="raised", command=lambda : self.apretar_button(self.button_c, self.app.button3), text=self.app.button3, width=13, height=2, compound="center", bg="White", font=("Bebas neue", 12, "bold"), fg="Black", wraplength=115)
        self.button_c.pack(side="left", padx=13, pady=20)

        self.button_d = Button(self.q_frame, relief="raised", command=lambda : self.apretar_button(self.button_d, self.app.button4), text=self.app.button4, width=13, height=2, compound="center", bg="White", font=("Bebas neue", 12, "bold"), fg="Black", wraplength=115)
        self.button_d.pack(side="left", padx=13, pady=20)
